...
import { createFormLangServices } from "../../src/language/form-lang-module-lsp.js";

let services: ReturnType<typeof createFormLangServices>;
let parse: ReturnType<typeof parseHelper<Model>>;
let document: LangiumDocument<Model> | undefined;

beforeAll(async () => {
  services = createFormLangServices(EmptyFileSystem);
  const doParse = parseHelper<Model>(services.FormLang);
