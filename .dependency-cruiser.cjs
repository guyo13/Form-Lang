...
module.exports = {
  forbidden: [
    {
      name: "vscode-languageserver-in-neutral-platforms",
      comment:
        "vscode-languageserver should not be bundled in neutral platforms",
      severity: "warn",
      from: {
        path: "src/lib/.*",
      },
    ...
    {
      name: "node-in-neutral-platforms",
      comment: "node:* should not be bundled in neutral platforms",
      severity: "warn",
      from: {
        path: "src/lib/.*",
      },
...
// generated: dependency-cruiser@16.9.0 on 2025-02-01T17:41:49.344Z
